Feature: Delete Booking Module
   ...
   Scenario Outline: TC_33 → Successful booking deletion with valid credentials 
    ...
    Examples:
      | auth_condition                      | status_code | message |
      | I have a valid authentication token | 201         | Created |
